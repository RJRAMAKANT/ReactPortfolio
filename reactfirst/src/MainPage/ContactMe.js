function ContactMe(){
    return<div class="font-[sans-serif] max-w-6xl mx-auto relative rounded-lg py-6 pt-10" >
    <div class="grid lg:grid-cols-3 items-center">
      <div class="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
        ...
        <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
          ...
          <p class="text-sm text-gray-600 mt-2">Code island</p>
        </div>
      </div>

      <div class="lg:col-span-2 dark:bg-gray-900 dark:border-Brightsun-400 dark:rounded-3xl  hover:bg-Brightsun-600 hover:bg-opacity-80 transition-all duration-500 ease-in-out hover:cursor-pointer  dark:border-8 bg-Brightsun-400 bg-opacity-50 rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
